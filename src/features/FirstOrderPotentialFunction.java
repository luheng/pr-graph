...
public class FirstOrderPotentialFunction {	
	...
	public double computeScore(int sid, int pos, int s, int sp,
			double[] parameters) {	
		return computeNodeScore(sid, pos, s, parameters) +
				computeEdgeScore(sid, pos, s, sp, parameters);
	}
	
	public double computeEdgeScore(int sid, int pos, int s, int sp,
			double[] parameters) {
		double r = 0;
	...
	public void addToEmpirical(int sid, int pos, int s, int sp,
