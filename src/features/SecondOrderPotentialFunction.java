...
public class SecondOrderPotentialFunction {
	...
	public double computeScore(int sid, int pos, int s, int sp, int spp,
			double[] parameters) {	
		return computeNodeScore(sid, pos, s, parameters) +
				computeEdgeScore(sid, pos, s, sp, spp, parameters);
	}
	
	public double computeEdgeScore(int sid, int pos, int s, int sp, int spp,
			double[] parameters) {
		double r = 0;
	...
	public double computeNodeScore(int sid, int pos, int s,
			double[] parameters) {
		double r = 0;
		int[] fid;
		double[] fv;
	...
	public void addToEmpirical(int sid, int pos, int s, int sp, int spp,
